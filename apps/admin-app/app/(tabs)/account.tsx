      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          {[
            ...
            <TouchableOpacity key={item.label} style={styles.menuRow} activeOpacity={0.7}>
              <View style={styles.menuIconBox}>
                <IconSymbol size={18} name={item.icon} color="#C2185B" />
              </View>
        ...
        <View style={styles.menuGroup}>
          <TouchableOpacity style={styles.menuRow} activeOpacity={0.7}>
            <View style={styles.menuIconBox}>
              <IconSymbol size={18} name={'typhoon.fill' as any} color="#C2185B" />
            </View>
            <View style={styles.menuTextBlock}>
          ...
          <TouchableOpacity style={styles.menuRow} activeOpacity={0.7} onPress={() => router.push('/(tabs)/fees')}>
            <View style={styles.menuIconBox}>
              <IconSymbol size={18} name="fees" color="#C2185B" />
            </View>
            <View style={styles.menuTextBlock}>
          ...
          <TouchableOpacity style={styles.menuRow} activeOpacity={0.7}>
            <View style={styles.menuIconBox}>
              <IconSymbol size={18} name="doc.text" color="#C2185B" />
            </View>
            <View style={styles.menuTextBlock}>
...
const styles = StyleSheet.create({
  ...
  menuIconBox: {
    width: 36, height: 36, borderRadius: 8, backgroundColor: '#FCE4EC',
